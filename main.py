...
work_hour_entry = tk.Entry(timer, textvariable = work_hour, width = 4, font = ("Verdana", "58"), justify = "center", borderwidth=2, relief="groove")
...
work_minute_entry = tk.Entry(timer, justify = "center", textvariable = work_minute, width = 4, font = ("Verdana", "58"), borderwidth=2, relief="groove")
work_minute_entry.place(relx = 0.5, rely = 0.3, anchor = "n")

colon_label = tk.Label(timer, text = ":", font = ("Verdana", "40"), bg = "White")
colon_label.place(relx = 0.575, rely = 0.31, anchor = "n")

work_second_entry = tk.Entry(timer, justify = "center", textvariable = work_second, width = 4, font = ("Verdana", "58"), borderwidth=2, relief="groove")
work_second_entry.place(relx = 0.65, rely = 0.3, anchor = "n")

# Placing break timer and labels
break_hour_entry = tk.Entry(timer, justify = "center", textvariable = break_hour, width = 4, font = ("Verdana", "58"), borderwidth=2, relief="groove")
break_hour_entry.place(relx = 0.35, rely = 0.5, anchor = "n")

colon_label = tk.Label(timer, text = ":", font = ("Verdana", "40"), bg = "White")
colon_label.place(relx = 0.425, rely = 0.51, anchor = "n")

break_minute_entry = tk.Entry(timer, justify = "center", textvariable = break_minute, width = 4, font = ("Verdana", "58"), borderwidth=2, relief="groove")
break_minute_entry.place(relx = 0.5, rely = 0.5, anchor = "n")

colon_label = tk.Label(timer, text = ":", font = ("Verdana", "40"), bg = "White")
colon_label.place(relx = 0.575, rely = 0.51, anchor = "n")

break_second_entry = tk.Entry(timer, justify = "center", textvariable = break_second, width = 4, font = ("Verdana", "58"), borderwidth=2, relief="groove")
...
def start_timer():
    ...
    work_stats.write(work_hour.get() + " hours " + work_minute.get() + " minutes " + work_second.get() + " seconds \n\n")
    work_stats.close()
    ...
    work_stats_label = tk.Label(stats, width = 40, height = 30, font = ("Verdana", "18"), text = work_stats_read, bg = "white", borderwidth=2, relief="groove")
    ...
    while temp > -1:
        ...
        if (temp == 0):
            continue_timer = messagebox.askquestion("MotivateMe!", "Good job! You worked well :) \n" + "Would you like to continue to break?")
...
work_button = tk.Button(timer, text = "Start Working!", font = ("Verdana", "25"), bg = "white", command = start_timer, borderwidth=2, relief="groove")
...
if os.path.getsize(user + "_goals.txt") == 0:
    ...
    def save_goals():
        ...
        with open(user + "_goals_stats.txt") as f:
            ...
            if line_count > 0:
                if line_count == 0:
                    work_stats_label = tk.Label(stats, width = 35, height = 4, font = ("Verdana", "25"), text = "You have " + str(line_count) + " goal left to complete. \nKeep going!", bg = "white", borderwidth=2, relief="groove")
                    work_stats_label.place(relx = 0.2, rely = 0.1, anchor = "n")
                else:
                    work_stats_label = tk.Label(stats, width = 35, height = 4, font = ("Verdana", "25"), text = "You have " + str(line_count) + " goals left to complete. \nKeep going!", bg = "white", borderwidth=2, relief="groove")
                    work_stats_label.place(relx = 0.2, rely = 0.1, anchor = "n")
            else:
                work_stats_label = tk.Label(stats, width = 35, height = 4, font = ("Verdana", "25"), text = "All goals completed! Great job!", bg = "white", borderwidth=2, relief="groove")
                work_stats_label.place(relx = 0.2, rely = 0.1, anchor = "n")
        ...
        morning_button_1 = tk.Button(goals, takefocus = False, font = ("Verdana", "20"), text = "☑", bg = "white", command = morning_1_complete(), borderwidth=2, relief="groove")
        ...
        def morning_2_complete():
            ...
            if len(morning_label_2.cget("text")) != -1:
                ...
                morning_label_2 = tk.Label(goals, width = 15, text = "No Goal Set", font = ("Verdana", "25"), bg = "white", borderwidth=2, relief="groove")
                morning_label_2.place(relx = 0.5, rely = 0.2, anchor = "n")
        ...
        morning_button_2 = tk.Button(goals, takefocus = False, font = ("Verdana", "20"), text = "☑", bg = "white", command = morning_2_complete(), borderwidth=2, relief="groove")
        ...
        def morning_3_complete(): 
            ...
            if len(morning_label_3.cget("text")) != -1:
                ...
                morning_label_3 = tk.Label(goals, width = 15, text = "No Goal Set", font = ("Verdana", "25"), bg = "white", borderwidth=2, relief="groove")
                morning_label_3.place(relx = 0.8, rely = 0.15, anchor = "n")
        ...
        morning_button_3 = tk.Button(goals, takefocus = False, font = ("Verdana", "20"), text = "☑", bg = "white", command = morning_3_complete(), borderwidth=2, relief="groove")
        ...
        def afternoon_1_complete(): 
            ...
            if len(afternoon_label_1.cget("text")) != -1:
                ...
                afternoon_label_1 = tk.Label(goals, width = 15, font = ("Verdana", "25"), text = "No Goal Set", bg = "white", borderwidth=2, relief="groove")
                afternoon_label_1.place(relx = 0.2, rely = 0.5, anchor = "n")
        ...
        afternoon_button_1 = tk.Button(goals, takefocus = False, font = ("Verdana", "20"), text = "☑", bg = "white", command = afternoon_1_complete(), borderwidth=2, relief="groove")
        ...
        def afternoon_2_complete(): 
            ...
            if len(afternoon_label_2.cget("text")) != -1:
                ...
                afternoon_label_2 = tk.Label(goals, width = 15, font = ("Verdana", "25"), text = "No Goal Set", bg = "white", borderwidth=2, relief="groove")
                afternoon_label_2.place(relx = 0.5, rely = 0.5, anchor = "n")
        ...
        afternoon_button_2 = tk.Button(goals, takefocus = False, font = ("Verdana", "20"), text = "☑", bg = "white", command = afternoon_2_complete(), borderwidth=2, relief="groove")
        ...
        def afternoon_3_complete():
            ...
            if len(afternoon_label_3.cget("text")) != -1:
                ...
                afternoon_label_3 = tk.Label(goals, width = 15, text = "No Goal Set", font = ("Verdana", "25"), bg = "white", borderwidth=2, relief="groove")
                afternoon_label_3.place(relx = 0.8, rely = 0.5, anchor = "n")
        ...
        afternoon_button_3 = tk.Button(goals, takefocus = False, font = ("Verdana", "20"), text = "☑", bg = "white", command = afternoon_3_complete(), borderwidth=2, relief="groove")
        ...
        def evening_1_complete():
            ...
            if len(evening_label_1.cget("text")) != -1:
                ...
                evening_label_1 = tk.Label(goals, width = 15, text = "No Goal Set", font = ("Verdana", "25"), bg = "white", borderwidth=2, relief="groove")
                evening_label_1.place(relx = 0.2, rely = 0.8, anchor = "n")
        ...
        evening_button_1 = tk.Button(goals, takefocus = False, font = ("Verdana", "20"), text = "☑", bg = "white", command = evening_1_complete(), borderwidth=2, relief="groove")
        ...
        def evening_2_complete():
            ...
            if len(evening_label_2.cget("text")) != 0:
                ...
                evening_label_2 = tk.Label(goals, width = 15, text = "No Goal Set", font = ("Verdana", "25"), bg = "white", borderwidth=2, relief="groove")
                evening_label_2.place(relx = 0.5, rely = 0.75, anchor = "n")
        ...
        evening_button_2 = tk.Button(goals, takefocus = False, font = ("Verdana", "20"), text = "☑", bg = "white", command = evening_2_complete(), borderwidth=2, relief="groove")
        ...
        def evening_3_complete():
            ...
            if len(evening_label_3.cget("text")) != 0:
                ...
                evening_label_3 = tk.Label(goals, width = 15, text = "No Goal Set", font = ("Verdana", "25"), bg = "white", borderwidth=2, relief="groove")
                evening_label_3.place(relx = 0.8, rely = 0.8, anchor = "n")
        ...
        evening_button_3 = tk.Button(goals, takefocus = False, font = ("Verdana", "20"), text = "☑", bg = "white", command = evening_3_complete(), borderwidth=2, relief="groove")
        evening_button_3.place(relx = 0.8, rely = 0.85, anchor = "n")

    save_goals_button = tk.Button(goals, text = "Save", command = lambda : [save_goals(), save_goals_button.destroy()], bg = "white", font = ("Verdana", "15"), width = 8, borderwidth=2, relief="groove")
        ...
        def afternoon_1_complete(): 
            with open(user + "_goals.txt", "r") as fp:
                ...
                if len(afternoon_label_1.cget("text")) != 0:
                    ...
                    afternoon_label_1 = tk.Label(goals, width = 15, text = "No Goal Set", font = ("Verdana", "25"), bg = "white", borderwidth=2, relief="groove")
                    afternoon_label_1.place(relx = 0.2, rely = 0.5, anchor = "n")
        ...
        def afternoon_2_complete(): 
            with open(user + "_goals.txt", "r") as fp:
                ...
                if len(afternoon_label_2.cget("text")) != 0:
                    ...
                    afternoon_label_2 = tk.Label(goals, width = 15, text = "No Goal Set", font = ("Verdana", "25"), bg = "white", borderwidth=2, relief="groove")
                    afternoon_label_2.place(relx = 0.5, rely = 0.5, anchor = "n")
...
if os.path.getsize(user + "_timetable.txt") == 0:
    ...
    # Entries
    # First Column
    schedule_entry_1 = tk.Entry(timetable, justify = "center", width = 15, font = ("Verdana", "25"), borderwidth=2, relief="groove")
    schedule_entry_1.place(relx = 0.2, rely = 0.1, anchor = "n")

    time_entry_1 = tk.Entry(timetable, justify = "center", width = 7, font = ("Verdana", "20"), borderwidth=2, relief="groove")
    time_entry_1.place(relx = 0.155, rely = 0.15, anchor = "n")

    schedule_entry_2 = tk.Entry(timetable, justify = "center", width = 15, font = ("Verdana", "25"), borderwidth=2, relief="groove")
    schedule_entry_2.place(relx = 0.2, rely = 0.27, anchor = "n")

    time_entry_2 = tk.Entry(timetable, justify = "center", width = 7, font = ("Verdana", "20"), borderwidth=2, relief="groove")
    time_entry_2.place(relx = 0.155, rely = 0.32, anchor = "n")

    schedule_entry_3 = tk.Entry(timetable, justify = "center", width = 15, font = ("Verdana", "25"), borderwidth=2, relief="groove")
    schedule_entry_3.place(relx = 0.2, rely = 0.44, anchor = "n")

    time_entry_3 = tk.Entry(timetable, justify = "center", width = 7, font = ("Verdana", "20"), borderwidth=2, relief="groove")
    time_entry_3.place(relx = 0.155, rely = 0.49, anchor = "n")

    schedule_entry_4 = tk.Entry(timetable, justify = "center", width = 15, font = ("Verdana", "25"), borderwidth=2, relief="groove")
    schedule_entry_4.place(relx = 0.2, rely = 0.61, anchor = "n")

    time_entry_4 = tk.Entry(timetable, justify = "center", width = 7, font = ("Verdana", "20"), borderwidth=2, relief="groove")
    time_entry_4.place(relx = 0.155, rely = 0.66, anchor = "n")

    schedule_entry_5 = tk.Entry(timetable, justify = "center", width = 15, font = ("Verdana", "25"), borderwidth=2, relief="groove")
    schedule_entry_5.place(relx = 0.2, rely = 0.78, anchor = "n")

    time_entry_5 = tk.Entry(timetable, justify = "center", width = 7, font = ("Verdana", "20"), borderwidth=2, relief="groove")
    time_entry_5.place(relx = 0.155, rely = 0.83, anchor = "n")

    # Second Column
    schedule_entry_6 = tk.Entry(timetable, justify = "center", width = 15, font = ("Verdana", "25"), borderwidth=2, relief="groove")
    schedule_entry_6.place(relx = 0.5, rely = 0.1, anchor = "n")

    time_entry_6 = tk.Entry(timetable, justify = "center", width = 7, font = ("Verdana", "20"), borderwidth=2, relief="groove")
    time_entry_6.place(relx = 0.455, rely = 0.15, anchor = "n")

    schedule_entry_7 = tk.Entry(timetable, justify = "center", width = 15, font = ("Verdana", "25"), borderwidth=2, relief="groove")
    schedule_entry_7.place(relx = 0.5, rely = 0.27, anchor = "n")

    time_entry_7 = tk.Entry(timetable, justify = "center", width = 7, font = ("Verdana", "20"), borderwidth=2, relief="groove")
    time_entry_7.place(relx = 0.455, rely = 0.32, anchor = "n")

    schedule_entry_8 = tk.Entry(timetable, justify = "center", width = 15, font = ("Verdana", "25"), borderwidth=2, relief="groove")
    schedule_entry_8.place(relx = 0.5, rely = 0.44, anchor = "n")

    time_entry_8 = tk.Entry(timetable, justify = "center", width = 7, font = ("Verdana", "20"), borderwidth=2, relief="groove")
    time_entry_8.place(relx = 0.455, rely = 0.49, anchor = "n")

    schedule_entry_9 = tk.Entry(timetable, justify = "center", width = 15, font = ("Verdana", "25"), borderwidth=2, relief="groove")
    schedule_entry_9.place(relx = 0.5, rely = 0.61, anchor = "n")

    time_entry_9 = tk.Entry(timetable, justify = "center", width = 7, font = ("Verdana", "20"), borderwidth=2, relief="groove")
    time_entry_9.place(relx = 0.455, rely = 0.66, anchor = "n")

    schedule_entry_10 = tk.Entry(timetable, justify = "center", width = 15, font = ("Verdana", "25"), borderwidth=2, relief="groove")
    schedule_entry_10.place(relx = 0.5, rely = 0.78, anchor = "n")

    time_entry_10 = tk.Entry(timetable, justify = "center", width = 7, font = ("Verdana", "20"), borderwidth=2, relief="groove")
    time_entry_10.place(relx = 0.455, rely = 0.83, anchor = "n")

    # Third Column
    schedule_entry_11 = tk.Entry(timetable, justify = "center", width = 15, font = ("Verdana", "25"), borderwidth=2, relief="groove")
    schedule_entry_11.place(relx = 0.8, rely = 0.1, anchor = "n")

    time_entry_11 = tk.Entry(timetable, justify = "center", width = 7, font = ("Verdana", "20"), borderwidth=2, relief="groove")
    time_entry_11.place(relx = 0.755, rely = 0.15, anchor = "n")

    schedule_entry_12 = tk.Entry(timetable, justify = "center", width = 15, font = ("Verdana", "25"), borderwidth=2, relief="groove")
    schedule_entry_12.place(relx = 0.8, rely = 0.27, anchor = "n")

    time_entry_12 = tk.Entry(timetable, justify = "center", width = 7, font = ("Verdana", "20"), borderwidth=2, relief="groove")
    time_entry_12.place(relx = 0.755, rely = 0.32, anchor = "n")

    schedule_entry_13 = tk.Entry(timetable, justify = "center", width = 15, font = ("Verdana", "25"), borderwidth=2, relief="groove")
    schedule_entry_13.place(relx = 0.8, rely = 0.44, anchor = "n")

    time_entry_13 = tk.Entry(timetable, justify = "center", width = 7, font = ("Verdana", "20"), borderwidth=2, relief="groove")
    time_entry_13.place(relx = 0.755, rely = 0.49, anchor = "n")

    schedule_entry_14 = tk.Entry(timetable, justify = "center", width = 15, font = ("Verdana", "25"), borderwidth=2, relief="groove")
    schedule_entry_14.place(relx = 0.8, rely = 0.61, anchor = "n")

    time_entry_14 = tk.Entry(timetable, justify = "center", width = 7, font = ("Verdana", "20"), borderwidth=2, relief="groove")
    time_entry_14.place(relx = 0.755, rely = 0.66, anchor = "n")

    schedule_entry_15 = tk.Entry(timetable, justify = "center", width = 15, font = ("Verdana", "25"), borderwidth=2, relief="groove")
    schedule_entry_15.place(relx = 0.8, rely = 0.78, anchor = "n")

    time_entry_15 = tk.Entry(timetable, justify = "center", width = 7, font = ("Verdana", "20"), borderwidth=2, relief="groove")
...
def play_lofi():
    ...
    def pause_lofi():
        mixer.music.pause()    
    lofi_pause_button = tk.Button(music, takefocus = False, font = ("Verdana", "25"), text = "Pause", bg = "white", command = pause_lofi, borderwidth=2, relief="groove")
...
lofi_button = tk.Button(music, takefocus = False, font = ("Verdana", "25"), text = "Play", bg = "white", command = play_lofi, borderwidth=2, relief="groove")
...
def play_lyrics():
    ...
    def pause_lyrics():
        mixer.music.pause()  
    lofi_pause_button = tk.Button(music, takefocus = False, font = ("Verdana", "25"), text = "Pause", bg = "white", command = pause_lyrics, borderwidth=2, relief="groove")
...
lyrics_button = tk.Button(music, takefocus = False, font = ("Verdana", "25"), text = "Play", bg = "white", command = play_lyrics, borderwidth=2, relief="groove")
...
work_stats_label = tk.Label(stats, width = 40, height = 29, font = ("Verdana", "18"), text = work_stats_read, bg = "white", borderwidth=2, relief="groove")
work_stats_label.place(relx = 0.8, rely = 0.1, anchor = "n")
...
''' Reset page '''
def reset_work():
    okcancel = messagebox.askokcancel("MotivateMe!", "Are you sure you'd like to reset your work? Re-run MotivateMe! after a reset.")
    if okcancel:
        open(user + "_work_stats.txt", "w").close()
        root.destroy()

reset_work_button = tk.Button(reset, takefocus = False, width = 20, height = 1, command = reset_work, font = ("Verdana", "25"), text = "Reset Work Times", bg = "white", borderwidth=2, relief="groove")
reset_work_button.place(relx = 0.5, rely = 0.18, anchor = "n")

def reset_goals():   
    okcancel = messagebox.askokcancel("MotivateMe!", "Are you sure you'd like to reset your goals? Re-run MotivateMe! after a reset.")
    if okcancel:
        open(user + "_goals.txt", "w").close()
        open(user + "_goals_stats.txt", "w").close()
        root.destroy()

reset_goals_button = tk.Button(reset, takefocus = False, width = 20, height = 1, command = reset_goals, font = ("Verdana", "25"), text = "Reset Goals", bg = "white", borderwidth=2, relief="groove")
reset_goals_button.place(relx = 0.5, rely = 0.36, anchor = "n")

def reset_timetable():
    okcancel = messagebox.askokcancel("MotivateMe!", "Are you sure you'd like to reset your timetable? Re-run MotivateMe! after a reset.")
    if okcancel:
        open(user + "_timetable.txt", "w").close()
        root.destroy()

reset_timetable_button = tk.Button(reset, takefocus = False, width = 20, height = 1, command = reset_timetable, font = ("Verdana", "25"), text = "Reset Timetable", bg = "white", borderwidth=2, relief="groove")
reset_timetable_button.place(relx = 0.5, rely = 0.54, anchor = "n")

def reset_all():
    okcancel = messagebox.askokcancel("MotivateMe!", "Are you sure you'd like to reset all? Re-run MotivateMe! after a reset.")
    if okcancel:
        open(user + "_timetable.txt", "w").close()
        open(user + "_goals.txt", "w").close()
        open(user + "_goals_stats.txt", "w").close()
...
reset_all_button = tk.Button(reset, takefocus = False, width = 20, height = 1, command = reset_all, font = ("Verdana", "25"), text = "Reset All", bg = "white", borderwidth=2, relief="groove")
